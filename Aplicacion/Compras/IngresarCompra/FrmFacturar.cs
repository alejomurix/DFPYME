...
namespace Aplicacion.Compras.IngresarCompra
{
    public partial class FrmFacturar : Form
    {
                    ...
                    if (ValidarFecha())
                    {
                        ...
                        if (rta.Equals(DialogResult.Yes))
                        {
                            ...
                            foreach (DataGridViewRow gRow in this.dgvArticulos.Rows)
                            {
                                ...
                                producto.Producto.ValorCosto = producto.Producto.ValorVentaProducto = Convert.ToDouble(gRow.Cells["Costo"].Value); // modificación porque se debe almacenar el costo sin iva
        ...
        private void EditarImpoconsumo(int rowIndex, string costo)
        {
            try
            {
                DataGridViewRow gridRow = this.dgvArticulos.Rows[this.dgvArticulos.CurrentRow.Index];
        ...
        private void CargarDatos()
        {
            try
            {
                ...
                double subTotal = Convert.ToDouble(UseObject.RemoveSeparatorMil(this.txtSubTotal.Text).ToString().Replace('.', ','));
