...
{
    public partial class FrmPrintCompra : Form
    {
        ...
        private void FrmPrintFactura_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                this.RptvCartera.LocalReport.DataSources.Add(
                                    new Microsoft.Reporting.WinForms.ReportDataSource("DsCompraSimple", Tabla));
                this.RptvCartera.LocalReport.ReportPath = this.ReportPath;

                var pConsulta = new ReportParameter();
                pConsulta.Name = "Consulta";
                pConsulta.Values.Add(Consulta);
                this.RptvCartera.LocalReport.SetParameters(pConsulta);
