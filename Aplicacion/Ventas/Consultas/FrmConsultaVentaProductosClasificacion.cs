...
{
    public partial class FrmConsultaVentaProductosClasificacion : Form
    {
        ...
        public FrmConsultaVentaProductosClasificacion()
        {
            InitializeComponent();
            try
            {
        ...
        private void FrmConsultaVentaProductos_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                this.cbClasificacion.DataSource = this.miBussinesCliente.Clasificacion();
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            this.IdClasificacion = Convert.ToInt32(this.cbClasificacion.SelectedValue);
        ...
        private void Consultar()
        {
            try
            {
                if (String.IsNullOrEmpty(this.CodProducto))  // Sin producto
                {
                    if (this.IndexCategoria == 0)  //  Todas las categorias
                    {
                        if (this.IdMarca == 0)  // Todas las marcas
                        {
                            //ConsultaVentasClasificacionCliente(DateTime fecha, DateTime fecha2, int idClasificacion)
                            this.Tdatos = this.miBussinesVenta.ConsultaVentasClasificacionCliente(this.fecha, this.fecha2, this.IdClasificacion);
                        }
                        else  // Marca
                        {
                            //ConsultaVentasClasificacionCliente(DateTime fecha, DateTime fecha2, int idClasificacion, int idMarca)
                            this.Tdatos = this.miBussinesVenta.ConsultaVentasClasificacionCliente(this.fecha, this.fecha2, this.IdClasificacion, this.IdMarca);
                        }
                    }
                    else
                    {
                        if (this.IdMarca == 0)  // Categoria + Todas las marcas
                        {
                            //ConsultaVentasClasificacionCliente(DateTime fecha, DateTime fecha2, int idClasificacion, string codCategoria)
                            this.Tdatos = this.miBussinesVenta.ConsultaVentasClasificacionCliente(this.fecha, this.fecha2, this.IdClasificacion, this.CodCategoria);
                        }
                        else // Categoria + Marca
                        {
                            //ConsultaVentasClasificacionCliente(DateTime fecha, DateTime fecha2, int idClasificacion, string codCategoria, int idMarca)
                            this.Tdatos = this.miBussinesVenta.ConsultaVentasClasificacionCliente(this.fecha, this.fecha2, this.IdClasificacion, this.CodCategoria, this.IdMarca);
                        }
                    }
                }
                else   // Con Producto
                {
                    this.Tdatos = this.miBussinesVenta.ConsultaVentasClasificacionClienteProducto(this.fecha, this.fecha2, this.IdClasificacion, this.CodProducto);
                }
               // this.Tdatos = this.miBussinesVenta.ConsultaVentasClasificacionCliente(this.fecha, this.fecha2, this.IdClasificacion, this.CodCategoria);
            ...
            try
            {
                if (this.Tdatos.Rows.Count > 0)
                {
                   ...
                   /* var tProductos = this.Productos.ToDataTable();
                    ...
                    {
                        pClasificacion.Values.Add("Clasificación: " + this.cbClasificacion.Text);
                    }
