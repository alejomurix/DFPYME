...
{
    public partial class FrmPrecioProducto_2 : Form
    {
        ...
        private PreciosDeProducto precioProducto;

        public FrmPrecioProducto_2()
        {
            InitializeComponent();
            ...
            try
            {
                ...
                this.precioProducto = new PreciosDeProducto();
                this.precioProducto.UtilidadAntesIva = this.UtilidadAntesIva;
                this.precioProducto.CalculoUtilMultiplicado = this.CalculoUtilMultiplicado;
                if (this.miEmpresa.Regimen.IdRegimen.Equals(1))
                {
                    precioProducto.RegimenComun = true;
                }
                this.precioProducto.Redondear = this.RedondearPrecio2;
                this.precioProducto.AproximarPrecio = this.AproxPrecio;
            }
            catch (Exception ex)
            {
                        ...
                        if (CodigoOrString())
                        {
                            if (ValidarCodigo() || ValidarCodigoBarras())
                            {
                                if (ExisteProducto(txtCodigoArticulo.Text))
                                {
                                    ...
                                    this.precioProducto.producto = this.MiProducto;
                                    this.CargarCosto();
                                    CargarPrecioUno(false);
                                    CargarPrecioDos(false);
                                    CargarPrecioTres(false);

                                    //this.precioProducto.CargarPrecioUno();
            ...
            if (e.KeyChar.Equals((char)Keys.Enter))
            {
                if (!String.IsNullOrEmpty(this.txtCostoNoIvaP1.Text))
                {
                    ...
                    if (ValidarDouble(this.txtCostoNoIvaP1.Text.Replace('.', ',')))
                    {
                        MiError.SetError(this.txtCostoNoIvaP1, null);
                        EditaCostoPrecioUno(
                            PreciosDeProducto.OpcionCosto.CostoNoIva, Convert.ToDouble(this.txtCostoNoIvaP1.Text.Replace('.', ',')));
        ...
        private void cbIvaEditar_SelectionChangeCommitted(object sender, EventArgs e)
        {
            if (this.MiProducto != null)
            {
                ...
                this.precioProducto.producto.IdIva = ((Iva)cbIvaEditar.SelectedItem).IdIva;
                this.precioProducto.producto.ValorIva = ((Iva)cbIvaEditar.SelectedItem).PorcentajeIva;
                EditaCostoPrecioUno(
                    PreciosDeProducto.OpcionCosto.CostoMasIva, Convert.ToDouble(this.txtCostoConIvaP1.Text.Replace('.', ',')));
        ...
        private void txtUtilidadP1_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar.Equals((char)Keys.Enter))
            {
                if (!String.IsNullOrEmpty(this.txtUtilidadP1.Text))
                {
                    ...
                    if (this.ValidarDouble(this.txtUtilidadP1.Text.Replace('.', ',')))
                    {
                        this.MiError.SetError(this.txtUtilidadP1, null);
                        this.EditaVentaPrecioUno(false, Convert.ToDouble(this.txtUtilidadP1.Text.Replace('.', ',')));
        ...
        private void CargarProducto(string codigo)
        {
            ...
            this.MiProducto = this.miBussinesProducto.ProductoCompleto(codigo);
        ...
        {
            this.precioProducto.CargarCosto();

            this.txtCostoNoIvaP1.Text = this.txtCostoNoIvaP2.Text =
                this.txtCostoNoIvaP3.Text = this.txtCostoNoIvaP4.Text = this.MiProducto.ValorCosto.ToString().Replace(',', '.');

            this.txtIvaP1.Text = this.txtIvaP2.Text = this.txtIvaP3.Text = this.txtIvaP4.Text = this.MiProducto.ValorIva.ToString().Replace(',', '.');

            this.txtValorIvaP1.Text = this.txtValorIvaP2.Text = this.txtValorIvaP3.Text = 
                this.txtValorIvaP4.Text = this.precioProducto.CostoIva.ToString().Replace(',', '.');

            this.txtIcoP1.Text = this.txtIcoP2.Text = this.txtIcoP3.Text = this.txtIcoP4.Text = this.MiProducto.Impoconsumo.ToString().Replace(',', '.');

            this.txtCostoConIvaP1.Text = this.txtCostoConIvaP2.Text = this.txtCostoConIvaP3.Text =
                this.txtCostoConIvaP4.Text = this.precioProducto.CostoMasIvaMasIco.ToString().Replace(',', '.');
        }

        private void CargarPrecioUno(bool editaCosto)
        {
            this.precioProducto.CargarPrecioUno();
            ...
            this.txtValorUtilidadP1.Text = this.precioProducto.ValorUtilidad.ToString().Replace(',', '.');
            this.txtValIvaUtilidadP1.Text = this.precioProducto.ValorIvaUtilidad.ToString().Replace(',', '.');

            this.txtValorSugeridoP1.Text = this.precioProducto.ValorVenta.ToString().Replace(',', '.');
        ...
        private void CargarPrecioDos(bool editaCosto)
        {
            this.precioProducto.CargarPrecioDos();
            this.txtUtilidadP2.Text = this.MiProducto.Utilidad2.ToString().Replace(',', '.');

            this.txtIcoPV2.Text = this.txtIcoPV1.Text;
            this.txtValorUtilidadP2.Text = this.precioProducto.ValorUtilidad.ToString().Replace(',', '.');
            this.txtValIvaUtilidadP2.Text = this.precioProducto.ValorIvaUtilidad.ToString().Replace(',', '.');

            this.txtValorSugeridoP2.Text = this.precioProducto.ValorVenta.ToString().Replace(',', '.');

            if (!editaCosto)
            {
                this.txtValorVentaP2.Text = this.precioProducto.ValorVentaConDescto.ToString();
            }
        ...
        private void CargarPrecioTres(bool editaCosto)
        {
            /*this.precioProducto.CargarPrecioDos();
            this.txtUtilidadP2.Text = this.MiProducto.Utilidad2.ToString().Replace(',', '.');
            ...
            this.precioProducto.CargarPrecioTres();
            this.txtUtilidadP3.Text = this.MiProducto.Utilidad3.ToString().Replace(',', '.');

            this.txtIcoPV3.Text = this.txtIcoPV1.Text;
            this.txtValorUtilidadP3.Text = this.precioProducto.ValorUtilidad.ToString().Replace(',', '.');
            this.txtValIvaUtilidadP3.Text = this.precioProducto.ValorIvaUtilidad.ToString().Replace(',', '.');

            this.txtValorSugeridoP3.Text = this.precioProducto.ValorVenta.ToString().Replace(',', '.');

            if (!editaCosto)
            {
                this.txtValorVentaP3.Text = this.precioProducto.ValorVentaConDescto.ToString();
            }
        ...
        private void AjusteCostoIva()
        {
            try
            {
                ...
                this.txtIvaP1.Text = this.txtIvaP2.Text =
                    this.txtIvaP3.Text = this.txtIvaP4.Text = this.MiProducto.ValorIva.ToString().Replace(',', '.');
            }
            catch (Exception ex)
            {
                OptionPane.MessageError(ex.Message);
        ...
        private void EditaCostoPrecioUno(PreciosDeProducto.OpcionCosto opcion, double costo)
        {
            try
            {
                switch (opcion)
                {
                    case PreciosDeProducto.OpcionCosto.CostoNoIva:
                        {
                            this.precioProducto.Costo = costo;
                            break;
                        }
                    case PreciosDeProducto.OpcionCosto.CostoMasIva:
                        {
                            this.precioProducto.CostoMasIvaMasIco = costo;
                            break;
                        }
                }
                //this.precioProducto.Costo = costo;
                this.precioProducto.EditarCosto(opcion);

                this.txtCostoNoIvaP1.Text = this.precioProducto.Costo.ToString().Replace(',', '.');
                this.txtValorIvaP1.Text = this.precioProducto.CostoIva.ToString().Replace(',', '.');
                this.txtCostoConIvaP1.Text = this.precioProducto.CostoMasIvaMasIco.ToString().Replace(',', '.');
                ...
                this.CargarPrecioUno(true);
                this.CargarPrecioDos(true);
                this.CargarPrecioTres(true);
                ...
                if (e.KeyChar.Equals((char)Keys.Enter))
                {
                    if (!String.IsNullOrEmpty(this.txtIcoP1.Text))
                    {
                        ...
                        if (ValidarDouble(this.txtIcoP1.Text.Replace('.', ',')))
                        {
                            ...
                            this.precioProducto.producto.Impoconsumo = this.MiProducto.Impoconsumo = Convert.ToDouble(this.txtIcoP1.Text.Replace('.', ','));

                            this.EditaCostoPrecioUno(PreciosDeProducto.OpcionCosto.Impoconsumo, 0);
                            
                            //EditaCostoPrecioUno(false, Convert.ToDouble(this.txtCostoNoIvaP1.Text.Replace('.', ',')));  se editó
