    ...
    public partial class FrmConsultaIngreso : Form
    {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            else//fecha
            {
                ...
                {
                    Ingresos(this.dtpFecha.Value, this.dtpFecha1.Value);
                }
            }
            ColorearGrid();
        }
        ...
        private void PrintIngresoPos50mm(string numero)
        {
            try
            {
                ...
                ticket.AddHeaderLine(empresaRow["departamento"].ToString().ToUpper());
                ...
                ticket.AddHeaderLine("C.C o NIT: " + cliente.NitCliente);
                ticket.AddHeaderLine("---------------------------");
