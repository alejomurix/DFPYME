...
namespace BussinesLayer.Clases
{
    public class BussinesIngreso
    {
        ...
        {
            return miDaoIngreso.Ingresos(nitCliente, fecha, fecha2);
        }
        ...
        {
            return this.miDaoIngreso.TotalPayment(idCaja, beginDate, endDate);
        }

        public List<FormaPago> Payments(int idCaja, DateTime beginDate, DateTime endDate)
        {
            return this.miDaoIngreso.Payments(idCaja, beginDate, endDate);
        }
